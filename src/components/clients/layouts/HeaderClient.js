    ...
    >
      ...
      <div className="flex-col mt-1 ">
        ...
        <PopoverGroup className="hidden mt-1 lg:flex space-x-4">
          ...
          <a href="/branches" className="text-sm/6 font-semibold text-white  px-3 py-2 rounded-lg hover:bg-secondary hover:text-primary">
            Chi Nhánh
          </a>
          <a href="/about" className="text-sm/6 font-semibold text-white  px-3 py-2 rounded-lg hover:bg-secondary hover:text-primary">
            Về chúng tôi
          </a>
        </PopoverGroup>
      </div>
