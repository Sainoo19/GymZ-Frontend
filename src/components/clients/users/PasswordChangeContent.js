        ...
        <div className="py-8 px-4 md:px-8 max-w-4xl mx-auto">
            <div className="w-full bg-white p-6 md:p-8 rounded-xl shadow-md">
                <div className="flex flex-col md:flex-row md:items-center mb-6 gap-4">
                    <div className="bg-secondary rounded-full p-3 md:mr-4 w-fit">
                ...
                <div className="flex justify-between mb-8 relative">
                    {steps.map((s, i) => (
                        <div key={s.number} className="flex flex-col items-center relative z-10">
                            ...
                            <p className={`text-xs md:text-sm mt-2 ${step >= s.number ? 'text-primary font-medium' : 'text-gray-500'}`}>
                                {s.title}
                            </p>
                            {i < steps.length - 1 && (
                                <div className="absolute h-[2px] bg-gray-200 w-[70px] md:w-[100px] left-[60%] top-5 -z-10 hidden md:block">
                    ...
                    <div className="absolute h-[2px] bg-gray-200 w-[70%] left-[15%] top-5 -z-0 md:hidden">
                        <div className={`h-full bg-secondary transition-all duration-300 ${step === 1 ? 'w-0' : step === 2 ? 'w-1/2' : 'w-full'
                            }`}></div>
                    </div>
                </div>
                    ...
                    {step === 2 && (
                        <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
                            ...
                            <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4">
                                <button
                                    onClick={() => setStep(1)}
                                    className="order-2 md:order-1 md:flex-1 border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center"
                                >
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="order-1 md:order-2 md:flex-1 bg-secondary text-primary py-3 px-4 rounded-lg font-bold hover:bg-secondary/90 transition-colors flex items-center justify-center disabled:opacity-70"
                                >
                                    {loading && (
                                        <svg className="animate-spin h-5 w-5 mr-2" viewBox="0 0 24 24">
                                            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none"></circle>
