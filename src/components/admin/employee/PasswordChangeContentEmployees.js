...
function PasswordChangeContentEmployees() {
...
const API_URL = process.env.REACT_APP_API_URL;
    const handleRequestOtp = async () => {
        ...
        try {
            const response = await axios.post(`${API_URL}employees/request-password-change`, {
                currentPassword
            }, {
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            const response = await axios.post(`${API_URL}employees/verify-change-password-otp`, {
                otp
            }, {
                withCredentials: true
            });
    ...
    const handleChangePassword = async () => {
        ...
        try {
            const response = await axios.post(`${API_URL}employees/change-password`, {
                otp,
                newPassword
            }, {
                withCredentials: true
...
export default PasswordChangeContentEmployees;